...
datadir = '/home/rowanhuxley/Documents/Data_Various/BinRiv/TW_MMU/VOL90_270624_MRI/VOL90_27062024';
subID = '/'; %'VOL90';
tmpfilt = load_untouch_nii(strcat(datadir,subID,'MR176339_fMRI_binRivalry_run2_14.nii'));
...
restricted = load_untouch_nii(strcat(datadir,subID,'VOL90_V1_FUNC_mask.nii.gz'));
...
for CurRunNum = 1:size(voxelMean2)
    ...
    CurRun(MaxLocation+1:max(size(CurRun))) = NaN;
    Min = min(CurRun);
